 ...
 */
const generateAndUploadPrescriptionPdf = ({ doctor, patient, prescription, appointmentDate }) => {
  return new Promise((resolve, reject) => {
    ...
    // Left: Doctor info
    doc.fontSize(10).font("Helvetica-Bold").fillColor(teal).text("DOCTOR", 50, startY);
    ...
    // Right: Patient info
    doc.fontSize(10).font("Helvetica-Bold").fillColor(teal).text("PATIENT", 320, startY);
    doc.fillColor(darkGray).font("Helvetica")
      .text(patient.fullName, 320, startY + 16)
      .text(`ID: ${patient.patientId}`, 320, startY + 30)
      .text(`Date: ${appointmentDate || new Date().toLocaleDateString("en-GB")}`, 320, startY + 44);
    ...
    if (prescription.notes) {
      doc.fontSize(11).font("Helvetica-Bold").fillColor(teal).text("CLINICAL NOTES");
      doc.fontSize(10).font("Helvetica").fillColor(darkGray).text(prescription.notes);
      doc.moveDown(1);
    }
    ...
    if (!prescription.medicines || prescription.medicines.length === 0) {
      ...
      prescription.medicines.forEach((med, i) => {
        ...
        doc.font("Helvetica").fillColor(gray)
          .text(`Dosage: ${med.dosage || "—"}   |   Frequency: ${med.frequency || "—"}   |   Duration: ${med.duration || "—"}`, 65, doc.y + 2);
        if (med.instructions) {
          doc.fillColor("#9ca3af").text(`Note: ${med.instructions}`, 65, doc.y + 2);
        }
        doc.moveDown(0.5);
      });
    }
    ...
    doc.fontSize(8).fillColor(gray)
      .text("This prescription was generated by CareLine360 | For medical advice, consult your doctor.", 50, footerY, {
        align: "center",
